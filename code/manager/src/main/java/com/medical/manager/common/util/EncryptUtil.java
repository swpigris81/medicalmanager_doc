...
public class EncryptUtil {
 // 密钥是16位长度的byte[]进行Base64转换后得到的字符串  
    ...
    public static void main(String[] args) {  
        System.out.println(encrypt("1234561111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111"));  
        try {
            System.out.println(decrypt("SFwu6ATK0hmI/B0JB8CVRaK5wssOaVUGuvGzNKyihC6v53ilFYm7RIdVXNC1X5VYP5zJnxyDuMb7tiIPCZlNTAqpxXVnCoaGo+yezeGOjV/wKgbJy1s5RQ/mtwH5X2auM9wvdXD249eB3+G2pCmNvvZbyx+wtf7k"));
        } catch (Exception e) {
